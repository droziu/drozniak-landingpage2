...
const ClientDocumentsView = ()=>{
    _s();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$app$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const { panelClient } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$app$2f$hooks$2f$useClientPanel$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useClientPanel"])();
        ...
        "ClientDocumentsView.useEffect": ()=>{
            ...
            ({
                "ClientDocumentsView.useEffect": async ()=>{
                    setLoading(true);
                    // Pobierz dokumenty
                    const { data: docsData, error: docsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('client_documents').select('id, doc_type, name, file_url, created_at').order('created_at', {
                        ascending: false
                    });
                    if (!docsError) setDocs(docsData || []);
                    // Pobierz oferty (jeśli panelClient istnieje, RLS zadziała automatycznie)
                    if (panelClient) {
                        const { data: propsData, error: propsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('proposals').select('id, title, status, created_at, valid_until').order('created_at', {
                            ascending: false
                        });
                        if (!propsError && propsData) {
                            ...
                            const proposalsWithLinks = await Promise.all(propsData.map({
                                "ClientDocumentsView.useEffect": async (prop)=>{
                                    const { data: linkData } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('proposal_access_links').select('token').eq('proposal_id', prop.id).eq('status', 'active').single();
                                    return {
                                        ...prop,
        ...
        "ClientMarketingView.useEffect": ()=>{
            ...
            ({
                "ClientMarketingView.useEffect": async ()=>{
                    setLoading(true);
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('funnel_diagrams').select('id, project_name, status, updated_at').in('status', [
                        'active',
                        'draft'
                    ...
                    const { data: access } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('funnel_access').select('funnel_id').eq('client_id', panelClient.marketing_client_id);
...
const ClientDataView = ()=>{
            ...
            ({
                "ClientDataView.useEffect": async ()=>{
                    const [profileRes, panelClientRes] = await Promise.all([
                        __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', user.id).maybeSingle(),
                        // Używamy select('*') zamiast tylko display_name - jeśli kolumna nie istnieje, zwróci błąd, ale możemy go obsłużyć
                        __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('panel_clients').select('*').eq('user_id', user.id).maybeSingle()
                    ]);
    ...
    const onSave = async (e)=>{
        ...
        try {
            ...
            // Zapisz do profiles
            const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').upsert({
                id: user.id,
            ...
            const { data: pcData } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('panel_clients').select('id').eq('user_id', user.id).maybeSingle();
            if (pcData) {
                const { error: pcError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('panel_clients').update({
        ...
        "ClientProjectsView.useEffect": ()=>{
            ...
            ({
                "ClientProjectsView.useEffect": async ()=>{
                    setLoading(true);
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('client_projects').select('id, project_type, name, status, updated_at').order('updated_at', {
                        ascending: false
                    });
...
//# sourceMappingURL=strony_www_drozniak-landingpage_5b66c09f._.js.map