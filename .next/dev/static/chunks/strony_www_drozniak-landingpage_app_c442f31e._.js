...
"[project]/strony_www/drozniak-landingpage/app/panel/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PanelRootPage.useEffect": ()=>{
            if (!loading) {
                ...
                if (viewGrants.length > 0) {
                    const orderedGrants = TAB_ORDER.filter({
                        "PanelRootPage.useEffect.orderedGrants": (t)=>viewGrants.includes(t)
                    }["PanelRootPage.useEffect.orderedGrants"]);
...
_s(PanelRootPage, "RS98A8BsbUx6gh09ogyMrYhaum4=", false, function() {
    return [
...
_c = PanelRootPage;
var _c;
__turbopack_context__.k.register(_c, "PanelRootPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=strony_www_drozniak-landingpage_app_c442f31e._.js.map