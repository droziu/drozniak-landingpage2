module.exports = [
"[project]/strony_www/drozniak-landingpage/app/szkolenia/layout.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const metadata = {
    ...
    keywords: [
        ...
        'szkolenia AI w marketingu',
        'AI w marketingu dla małych firm'
    ],
    openGraph: {
        title: 'Szkolenia z AI w marketingu dla małych firm',
...
function SzkoleniaLayout({ children }) {
    return children;
}
}),
];

//# sourceMappingURL=strony_www_drozniak-landingpage_app_szkolenia_layout_tsx_6cfbd04e._.js.map