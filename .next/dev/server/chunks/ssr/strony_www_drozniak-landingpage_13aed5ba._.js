...
"[project]/strony_www/drozniak-landingpage/hooks/useClientPanel.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useClientPanel = ()=>{
    ...
    const load = async ()=>{
        ...
        try {
            ...
            // Używamy funkcji SECURITY DEFINER zamiast bezpośredniego zapytania - omija RLS
            const [pcRes, grantsRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('get_my_panel_client'),
                __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('get_my_view_grants')
            ]);
            console.log('useClientPanel: pcRes (from RPC)', pcRes);
            console.log('useClientPanel: pcRes.data', pcRes.data);
            console.log('useClientPanel: pcRes.error', pcRes.error);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/strony_www/drozniak-landingpage/lib/supabase.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/strony_www/drozniak-landingpage/hooks/useAuth.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$hooks$2f$useClientPanel$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/strony_www/drozniak-landingpage/hooks/useClientPanel.ts [app-ssr] (ecmascript)");
...
const ClientDocumentsView = ()=>{
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const { panelClient } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$hooks$2f$useClientPanel$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useClientPanel"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            setLoading(true);
            // Pobierz dokumenty
            const { data: docsData, error: docsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('client_documents').select('id, doc_type, name, file_url, created_at').order('created_at', {
                ascending: false
            });
            if (!docsError) setDocs(docsData || []);
            // Pobierz oferty (jeśli panelClient istnieje, RLS zadziała automatycznie)
            if (panelClient) {
                const { data: propsData, error: propsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('proposals').select('id, title, status, created_at, valid_until').order('created_at', {
                    ascending: false
                });
                if (!propsError && propsData) {
                    ...
                    const proposalsWithLinks = await Promise.all(propsData.map(async (prop)=>{
                        const { data: linkData } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('proposal_access_links').select('token').eq('proposal_id', prop.id).eq('status', 'active').single();
                        return {
                            ...prop,
...
const ClientMarketingView = ({ panelClient })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            setLoading(true);
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('funnel_diagrams').select('id, project_name, status, updated_at').in('status', [
                'active',
                'draft'
            ...
            const { data: access } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('funnel_access').select('funnel_id').eq('client_id', panelClient.marketing_client_id);
...
const ClientDataView = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            const [profileRes, panelClientRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', user.id).maybeSingle(),
                // Używamy select('*') zamiast tylko display_name - jeśli kolumna nie istnieje, zwróci błąd, ale możemy go obsłużyć
                __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('panel_clients').select('*').eq('user_id', user.id).maybeSingle()
            ]);
    ...
    const onSave = async (e)=>{
        ...
        try {
            ...
            // Zapisz do profiles
            const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').upsert({
                id: user.id,
            ...
            const { data: pcData } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('panel_clients').select('id').eq('user_id', user.id).maybeSingle();
            if (pcData) {
                const { error: pcError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('panel_clients').update({
...
const ClientProjectsView = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            setLoading(true);
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('client_projects').select('id, project_type, name, status, updated_at').order('updated_at', {
                ascending: false
            });
...
//# sourceMappingURL=strony_www_drozniak-landingpage_13aed5ba._.js.map