...
const AdminCoursesTab = ()=>{
    ...
    const loadUsers = async ()=>{
        if (!user) return;
        try {
            const { data: profiles, error: profilesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id, full_name, company_name, first_name, last_name, phone, notes, created_at').order('created_at', {
                ascending: false
            });
            if (profilesError) {
            ...
            const usersWithEmail = await Promise.all((profiles || []).map(async (profile)=>{
                try {
                    const { data: emailData, error: emailError } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('get_user_email', {
                        user_id: profile.id
                    });
                    return {
                        ...profile,
            ...
            for (const profile of usersWithEmail){
                ...
                const { data: certificateData } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('course_certificates').select('course_completed, course_ready_to_complete').eq('user_id', profile.id).maybeSingle();
                ...
                const { data: moduleProgressData } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('training_progress').select('*').eq('user_id', profile.id);
                const { data: responsesData } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('training_responses').select('*').eq('user_id', profile.id);
    ...
    const loadUserResponses = async (userId)=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('training_responses').select('*').eq('user_id', userId).order('created_at', {
                ascending: false
            });
    ...
    const handleQuickApprove = async (responseId, e)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('training_responses').update({
                status: 'approved',
                admin_feedback: null,
                reviewed_by: user?.id,
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: async ()=>{
                                                            ...
                                                            try {
                                                                setActionLoading(true);
                                                                const { data: existingCert } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('course_certificates').select('id').eq('user_id', selectedUser).maybeSingle();
                                                                if (!existingCert) {
                                                                    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('course_certificates').insert({
                                                                    ...
                                                                    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('course_certificates').update({
                                                                        course_ready_to_complete: true
...
const ClientManagement = ()=>{
    ...
    const loadClients = async ()=>{
        try {
            setLoading(true);
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('marketing_clients').select('*').order('created_at', {
                ascending: false
            });
            if (filterStatus !== 'all') {
                query = query.eq('status', filterStatus);
    ...
    const handleSaveClient = async ()=>{
        ...
        try {
            if (editingClient) {
                ...
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('marketing_clients').update({
                ...
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('marketing_clients').insert({
                    name: formData.name.trim(),
                    email: formData.email.trim() || null,
                    company_name: formData.company_name.trim() || null,
                    phone: formData.phone.trim() || null,
    ...
    const handleDeleteClient = (clientId)=>{
        setConfirmModal({
            ...
            onConfirm: async ()=>{
                ...
                try {
                    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('marketing_clients').delete().eq('id', clientId);
                    if (error) throw error;
                    setAlertModal({
                        isOpen: true,
                        title: 'Sukces',
...
const PanelClientsManagement = ()=>{
    ...
    const load = async ()=>{
        ...
        try {
            const [rpc, mc] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('get_panel_clients_for_admin'),
                __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('marketing_clients').select('id, name, company_name').eq('status', 'active').order('name')
            ]);
    ...
    const handleSave = async ()=>{
        ...
        try {
            if (modal === 'add') {
                const { data: uid, error: eu } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('get_user_id_by_email', {
                    em: form.email.trim()
                });
                if (eu || !uid) {
                    setAlert({
                ...
                const { data: pc, error: ep } = await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('panel_clients').insert({
                    user_id: uid,
                ...
                for (const tag of form.view_tags){
                    await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('client_view_grants').insert({
                        client_id: pc.id,
                        view_tag: tag,
                        granted_by: user.id
                    });
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('panel_clients').update({
                    name: form.name.trim() || null,
                    company_name: form.company_name.trim() || null,
                    marketing_client_id: form.marketing_client_id || null
                }).eq('id', editingId);
                await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('client_view_grants').delete().eq('client_id', editingId);
                for (const tag of form.view_tags){
                    await __TURBOPACK__imported__module__$5b$project$5d2f$strony_www$2f$drozniak$2d$landingpage$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('client_view_grants').insert({
                        client_id: editingId,
                        view_tag: tag,
...
//# sourceMappingURL=strony_www_drozniak-landingpage_e4905c2d._.js.map