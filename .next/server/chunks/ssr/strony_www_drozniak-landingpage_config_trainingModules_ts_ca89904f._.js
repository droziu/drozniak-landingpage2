module.exports=[5825,a=>{"use strict";let b=[{id:"1",title:"Podstawy marketingu online",icon:"chart",lessons:[{id:"1.1",moduleId:"1",title:"Wprowadzenie do marketingu cyfrowego",intro:`Marketing cyfrowy to wszystkie działania, kt\xf3re pomagają Twojej firmie zostać zauważoną, zbudować zaufanie i sprzedać swoje usługi z pomocą internetu.
...
• dopiero p\xf3źniej dzwonią, piszą lub rezerwują.
...
• posty kierujące do rezerwacji, zam\xf3wień, kontaktu,
• kampanie reklamowe (np. „rezerwuj ferie", „zam\xf3w z dostawą", „weekendowy pobyt LAST MINUTE"),
• zachęcanie do powrotu (oferty dla os\xf3b, kt\xf3re już były klientami).`,keyElements:[{title:"Treści informacyjne",description:"Aktualne informacje o firmie:",points:["aktualne godziny otwarcia, wolne terminy, nowe usługi","zmiany w ofercie (np. nowe dania, nowe pakiety, nowy sprzęt)"],icon:"info"},{title:'Treści pokazujące „kulisy"',description:"Autentyczne spojrzenie za kulisy:",points:["przygotowanie pokoju, sali, sprzętu, jedzenia",'fragmenty pracy zespołu (bez sztucznego „udawania")'],icon:"kulisy"},{title:"Treści sprzedażowe",description:"Konkretne promocje i zachęty:",points:['konkretne promocje, pakiety, zachęty (z jasnym wezwaniem do działania: „zadzwoń", „napisz", „zarezerwuj")',"grafiki z prostym komunikatem, a nie ścianą tekstu"],icon:"sales"},{title:"Treści budujące relacje",description:"Budowanie zaufania i zaangażowania:",points:["opinie klientów (za zgodą)",'zdjęcia „z życia" – np. zadowoleni goście, pełny lokal, dobra pogoda',"proste pytania do odbiorców, zachęcające do reakcji"],icon:"relacje"}],practicalExamples:[{title:"Przykład 1 – pensjonat / ośrodek w miejscowości turystycznej",description:'Zamiast publikować raz na kilka miesięcy, profil może być narzędziem do:\n• pokazywania aktualnych warunków (śnieg, widoki, atrakcje w okolicy),\n• informowania o wolnych terminach: „Zwolnił się pokój na weekend – kto pierwszy, ten lepszy",\n• pokazywania pakietów: nocleg + wyjazd na stok + termy.',effect:"Efekt: osoby planujące wyjazd widzą, że obiekt żyje, jest zadbany i ma realne atuty."},{title:"Przykład 2 – pizzeria / restauracja",description:'Profil na Facebooku / Instagramie może:\n• pokazywać realne zdjęcia dań, a nie tylko „stockowe" grafiki,\n• komunikować promocje czasowe (np. „środa – druga pizza -30% przy odbiorze osobistym"),\n• zachęcać do opinii i recenzji, które później zwiększają zaufanie nowych klientów,\n• dzięki reklamom docierać do osób z najbliższej okolicy.',effect:'Efekt: więcej osób przypomina sobie o lokalu, gdy myśli: „zamówmy coś na kolację".'},{title:"Przykład 3 – hotel / obiekt noclegowy",description:'• w sezonie: pokazywanie warunków na stokach, zadowolonych gości, aktualnych atrakcji,\n• poza sezonem: promowanie pobytów weekendowych, pakietów rodzinnych, ofert specjalnych (np. „Jesienny relaks + termy"),\n• stała obecność: krótkie relacje (Stories) z codziennych działań – śniadania, widok z okna, przygotowanie pokoi.',effect:"Efekt: klient, zanim wejdzie na stronę lub zadzwoni, już ma w głowie obraz miejsca – wie, czego się spodziewać."}],additionalInfo:`Warto jasno:
...
W praktyce: dobra treść to taka, kt\xf3ra jest przydatna, konkretna i napisana językiem człowieka, a nie urzędowym sloganem.`,whyImportant:`Dla małego hotelu, pensjonatu czy firmy usługowej:
...
Jeśli są konkretne, zrozumiałe i pokazują realne korzyści – klient łatwiej wybiera właśnie Ciebie.`,keyElements:[{title:"Konkretny odbiorca",description:'Piszemy „do kogoś", a nie „do wszystkich"',points:["Inaczej komunikujemy się z rodziną z dziećmi, inaczej z osobą w delegacji"],icon:"audience"},{title:"Jasny cel komunikatu",description:"Czy chcemy, żeby ktoś:",points:["zarezerwował nocleg?","zapytał o wycenę?","zapisał się na newsletter?"],icon:"goal"},{title:"Korzyści, nie tylko cechy",description:'Zamiast: „pokoje z łazienką",',points:['lepiej: „każdy pokój z prywatną łazienką – bez kolejek i bez dzielenia się z innymi gośćmi"'],icon:"benefits"},{title:"Prosty język",description:"Krótkie zdania, bez żargonu",points:["Im łatwiej się to czyta, tym większa szansa, że ktoś dotrwa do końca"],icon:"language"},{title:"Wezwanie do działania (CTA)",description:"Konkretne działanie dla odbiorcy",points:['np. „Zadzwoń", „Napisz wiadomość", „Sprawdź dostępne terminy na przyszły weekend"'],icon:"cta"}],practicalExamples:[{title:"Przykład 1 – hotel / pensjonat",description:`Zamiast og\xf3lnego komunikatu:
...
Napisz w wiadomości „REZERWACJA", wyślę dostępne terminy na najbliższy tydzień."`,effect:'Różnica: wiadomo dla kogo jest oferta (osoba w delegacji), są konkretne korzyści (śniadanie, parking, Wi-Fi), jest konkretne działanie („napisz w wiadomości…").'},{title:"Przykład 2 – lokalna restauracja",description:`Zamiast:
...
– „rodzina z dw\xf3jką dzieci przyjeżdżająca na weekend",
...
„W piątkowy wiecz\xf3r rodzina z dw\xf3jką dzieci przyjeżdża zmęczona po 5 godzinach jazdy. Dzieci od razu wskakują do przygotowanego pokoju z dwoma osobnymi ł\xf3żkami, a rodzice siadają przy gorącej herbacie w saloniku dla gości. Następnego dnia czeka na nich śniadanie od 8:00 – bez konieczności wychodzenia z budynku."

To dalej ta sama usługa – ale zupełnie inny poziom odczuwania.`,keyElements:[{title:"Bohater",description:"Ktoś konkretny: gość, klient, właściciel, pracownik",points:[],icon:"hero"},{title:"Punkt wyjścia",description:"Sytuacja początkowa, problem albo potrzeba",points:['np. „zmęczony po całym dniu w trasie", „szuka spokojnego miejsca do pracy"'],icon:"starting-point"},{title:"Konflikt / wyzwanie",description:"Co jest trudne, męczące, irytujące dla bohatera",points:["np. hałaśliwy hotel, brak parkingu, brak śniadania o wczesnej porze"],icon:"challenge"},{title:"Rozwiązanie",description:"Miejsce, usługa, sposób działania firmy, który usuwa problem",points:[],icon:"solution-story"},{title:"Rezultat",description:"Co się zmieniło po skorzystaniu z usługi",points:["np. wyspany gość, który zdążył na ważne spotkanie; rodzina, która miała spokojny wyjazd"],icon:"result"},{title:"Puenta / wezwanie do działania",description:'Konkret: „Zarezerwuj termin", „Napisz wiadomość, sprawdzimy dostępność"',points:[],icon:"cta-story"}],practicalExamples:[{title:"Przykład 1 – pensjonat w miejscowości turystycznej",description:`Suchy komunikat:

„U nas dobrze czują się rodziny z dziećmi."

Wersja storytellingowa:

„W zeszły weekend przyjechała do nas rodzina z dw\xf3jką dzieci, po raz pierwszy w tej okolicy.
...
W niedzielę przy śniadaniu zarezerwowali już kolejny termin – tym razem na dłuższy pobyt."`,effect:"Co tu działa: konkretny bohater (rodzina), konkretna scena (śniadanie, naleśniki, kawa), rezultat (chcą wrócić)."},{title:"Przykład 2 – hotel pod gości biznesowych",description:`Suchy komunikat:
...
Zorganizowaliśmy dla niego zestaw śniadaniowy „na wynos" i cichy stolik w lobby, gdzie m\xf3gł jeszcze raz przejrzeć slajdy przy kawie.

Po spotkaniu napisał, że „dzięki spokojnej nocy i porannemu ogarnięciu wszystkiego bez chaosu" podpisał kontrakt, na kt\xf3rym mu najbardziej zależało."`,effect:"Tu historia pokazuje: elastyczność, zrozumienie potrzeb gościa, realny efekt (kontrakt)."},{title:"Przykład 3 – restauracja / lokal gastronomiczny",description:`Suchy komunikat:
...
– „Zadzwoń, jeśli w delegacji też potrzebujesz spokojnego miejsca do pracy po godzinach."`,quiz:[{id:"q1",type:"choice",question:"Co jest kluczowym elementem dobrego storytellingu w marketingu?",options:["Maksymalnie dużo liczb i statystyk","Emocje, wyraźny bohater, problem i rozwiązanie","Bardzo formalny język i specjalistyczne słownictwo",'Brak konkretnej struktury – historia „ma się po prostu toczyć"'],correctAnswer:1,hint:"Pomyśl o tym, co sprawia, że historia jest zapamiętywana i angażująca...",feedback:"Dokładnie tak – dobry storytelling powinien zawierać emocje, wyraźnego bohatera, problem i rozwiązanie, co tworzy angażującą narrację."},{id:"q2",type:"choice",question:"Który z poniższych opisów NAJBARDZIEJ przypomina storytelling?",options:['„Mamy 25 pokoi, parking i bezpłatne Wi-Fi."','„Nasz hotel działa od 15 lat i był remontowany w 2018 roku."','„W zeszłym miesiącu gościła u nas para, która przyjechała tylko na jedną noc w drodze nad morze. Prosili o cichy pokój, bo poprzednią noc spędzili przy ruchliwej ulicy. Rano powiedzieli, że pierwszy raz od dawna naprawdę się wyspali i zapisali nasz adres na przyszły rok."','„Oferujemy wysoki standard obsługi i profesjonalne podejście do klienta."'],correctAnswer:2,hint:"Pomyśl o opisie, który opowiada konkretną historię z bohaterem, sytuacją i rezultatem...",feedback:"Zgadza się – ten opis zawiera wszystkie elementy storytellingu: konkretnego bohatera (para), sytuację (zmęczenie, hałas), rozwiązanie (cichy pokój) i rezultat (wyspani, chcą wrócić)."},{id:"q3",type:"choice",question:"Jak najlepiej zacząć tworzenie historii dla swojej firmy?",options:["Od ustalenia bohatera i jego sytuacji / problemu","Od wypisania wszystkich parametrów technicznych obiektu","Od napisania jak najdłuższego tekstu i skracania go dopiero na końcu","Od sprawdzenia, jak pisze konkurencja i skopiowania stylu"],correctAnswer:0,hint:"Pomyśl o pierwszym kroku – od czego powinna zaczynać się dobra historia...",feedback:"Dokładnie – pierwszym krokiem jest ustalenie bohatera i jego sytuacji lub problemu. To fundament każdej dobrej historii."},{id:"q4",type:"open",question:'Masz obiekt noclegowy. Dotychczasowy post na Facebooku brzmi: „Dziękujemy naszym gościom za wizytę, zapraszamy ponownie."\n\nTwoje zadanie:\n• zamień to na krótką historię z jedną konkretną sytuacją,\n• pokaż, co dokładnie goście docenili,\n• zakończ wezwaniem do działania.\n\nNapisz historię w 4–6 zdaniach.',keywords:["historia","goście","sytuacja","docenili","wezwanie","działanie","zarezerwuj","napisz","sprawdź","terminy"],hint:"Pomyśl o konkretnej sytuacji z gośćmi, co im się podobało i jak to opisać jako historię...",feedback:"Dziękuję za odpowiedź. To ćwiczenie pomoże Ci lepiej zrozumieć, jak przekształcać suche komunikaty w angażujące historie."}]},{id:"2.3",moduleId:"2",title:"Optymalizacja treści pod kątem SEO",intro:`SEO (Search Engine Optimization) to spos\xf3b pisania i układania treści tak, aby były zrozumiałe dla użytkownik\xf3w i łatwe do odczytania przez wyszukiwarki (np. Google).

Dobrze przygotowany tekst pozwala stronie pojawiać się wyżej w wynikach wyszukiwania, gdy ktoś wpisuje konkretne hasła, np. „nocleg blisko centrum" albo „hotel ze śniadaniem".`,whyImportant:[{title:"Zwiększyć widoczność w Google",description:"Strona pojawia się wyżej w wynikach wyszukiwania",points:[],icon:"visibility-seo"},{title:"Przyciągnąć właściwych klientów",description:"Osoby, które już szukają dokładnie takich usług",points:['np. „hotel z parkingiem i śniadaniem"'],icon:"target-seo"},{title:"Obniżyć koszt pozyskania klienta",description:"Ruch z wyszukiwarki jest organiczny, a nie płatny",points:[],icon:"cost-seo"}],whyImportantFooter:`Możesz mieć świetną ofertę i dobrze napisaną treść, ale jeśli:

• tekst nie zawiera sł\xf3w, kt\xf3re faktycznie wpisują klienci,
• nagł\xf3wek nic nie m\xf3wi,
• strona nie jest jasno opisana,

to duża część potencjalnych gości w og\xf3le na nią nie trafi.`,keyElements:[{title:"Słowa kluczowe (keywords)",description:"Frazy, które wpisuje klient",points:['np. „hotel blisko centrum miasta", „nocleg z parkingiem i śniadaniem", „weekend w górach dla par"',"Naturalne wplecenie w tytuł, nagłówki, pierwszy akapit i wybrane fragmenty opisu"],icon:"keywords"},{title:"Tytuł i nagłówki (H1, H2, H3)",description:"Struktura treści pomagająca użytkownikowi i wyszukiwarce",points:['H1 – główny tytuł strony (np. „Noclegi dla firm – spokojny hotel z parkingiem i śniadaniem")','H2 / H3 – nagłówki sekcji (np. „Dlaczego firmy wybierają nasz obiekt")'],icon:"headings"},{title:"Opis meta (meta description)",description:"Krótki opis wyświetlany w wynikach wyszukiwania",points:["Powinien zawierać główną frazę i zachęcać do kliknięcia",'np. „Kameralny hotel blisko centrum, śniadanie w cenie, bezpłatny parking. Sprawdź wolne terminy i zarezerwuj pobyt online."'],icon:"meta"},{title:"Treść główna (body)",description:'Tekst podzielony na sekcje, czytelny, bez „ściany tekstu"',points:["Krótkie akapity, wypunktowania, podkreślenie najważniejszych korzyści"],icon:"content-seo"},{title:"Linki wewnętrzne",description:"Odsyłacze do innych podstron w ramach strony",points:['Z bloga do oferty, z oferty do formularza kontaktowego, z „o nas" do „pokoje"',"Pomagają użytkownikowi i ułatwiają robotom Google zrozumienie struktury witryny"],icon:"links"},{title:"Zdjęcia i opisy alternatywne (alt)",description:"Nazwy plików i teksty alt opisujące zdjęcia",points:['Nazwa pliku: „pokoj-2-osobowy-z-balkonem.jpg" zamiast „IMG_1234.jpg"','Tekst alt: „Pokój dwuosobowy z balkonem i widokiem na park"'],icon:"images-seo"}],practicalExamples:[{title:'Przykład 1 – podstrona „Pokoje" w hotelu',description:`Zamiast kr\xf3tkiego, og\xf3lnego opisu:

„Oferujemy wygodne pokoje 1-, 2- i 3-osobowe."

lepsza wersja pod SEO i użytkownika:

„Oferujemy wygodne pokoje 1-, 2- i 3-osobowe dla gości indywidualnych, rodzin i os\xf3b podr\xf3żujących służbowo.

Wszystkie pokoje mają prywatną łazienkę, szybkie Wi-Fi oraz dostęp do śniadania w formie bufetu.

Jeśli szukasz spokojnego noclegu blisko centrum miasta, a jednocześnie blisko gł\xf3wnych tras dojazdowych – sprawdź nasze aktualne terminy."`,effect:'Tu pojawiają się naturalnie frazy: „nocleg blisko centrum miasta", „pokoje 1-, 2- i 3-osobowe", „śniadanie w formie bufetu", „szybkie Wi-Fi".'},{title:"Przykład 2 – oferta dla firm",description:`Sucha wersja:

„Przyjmujemy grupy pracownik\xf3w."

Wersja zoptymalizowana:

„Specjalizujemy się w noclegach dla pracownik\xf3w i gości biznesowych.

Oferujemy pokoje 2- i 3-osobowe z możliwością wystawienia faktury VAT, bezpłatny parking dla bus\xf3w oraz śniadania od godziny 6:30.

Jeśli szukasz stałej bazy noclegowej dla swojej firmy, skontaktuj się z nami – przygotujemy indywidualną ofertę dla grup."`,effect:'Frazy: „noclegi dla pracowników", „goście biznesowi", „baza noclegowa dla firmy".'},{title:"Przykład 3 – artykuł na blogu (lokalny SEO)",description:`Temat: „Jak zaplanować weekend w mieście X"
...
W tym artykule podpowiadamy, jak zaplanować 2 dni tak, aby zobaczyć najważniejsze miejsca i nie tracić czasu na dojazdy."`,effect:"Tutaj tekst może być dłuższy, ale od początku jasno wynika: dla kogo, gdzie, jaką korzyść daje."}],roleDescription:`Prosta checklista SEO dla pojedynczej podstrony:
...
Jeśli odpowiedź na większość pytań brzmi „tak" – treść jest na podstawowym poziomie przygotowana pod SEO.`,quiz:[{id:"q1",type:"choice",question:"Co NAJBARDZIEJ pomaga wyszukiwarce zrozumieć, o czym jest konkretna podstrona?",options:["Ilość zdjęć na stronie","Tylko długość tekstu","Tytuł, nagłówki i logiczna struktura treści","Kolorystyka i szata graficzna"],correctAnswer:2,hint:"Pomyśl o elementach, które pomagają wyszukiwarkom zrozumieć strukturę i tematykę treści...",feedback:"Dokładnie tak – tytuł, nagłówki i logiczna struktura treści to kluczowe elementy, które pomagają wyszukiwarce zrozumieć, o czym jest podstrona."},{id:"q2",type:"choice",question:"Który opis jest lepiej przygotowany pod SEO (przy założeniu, że chcesz pozyskiwać gości biznesowych)?",options:['„Zapraszamy do naszego obiektu, mamy pokoje i śniadania."','„Oferujemy noclegi dla pracowników i gości biznesowych: pokoje 2- i 3-osobowe, śniadania od 6:30, bezpłatny parking i możliwość wystawienia faktury VAT."','„U nas jest miło, spokojnie i komfortowo dla każdego."','„Nasz obiekt działa od 15 lat i znajduje się w dobrej lokalizacji."'],correctAnswer:1,hint:"Pomyśl o opisie, który zawiera konkretne frazy kluczowe i szczegóły istotne dla gości biznesowych...",feedback:'Zgadza się – ten opis zawiera konkretne frazy kluczowe („noclegi dla pracowników", „goście biznesowi") oraz szczegóły istotne dla tej grupy docelowej.'},{id:"q3",type:"choice",question:"Który element JEST przykładem optymalizacji SEO?",options:['Zmienienie koloru przycisku „Rezerwuj" z niebieskiego na czerwony',"Dodanie większej liczby zdjęć bez opisów","Skrócenie tekstu o połowę, bez zmiany treści","Uzupełnienie opisu meta i nagłówków o frazy, które wpisują klienci w Google"],correctAnswer:3,hint:"Pomyśl o elementach, które bezpośrednio wpływają na widoczność w wynikach wyszukiwania...",feedback:"Dokładnie – uzupełnienie opisu meta i nagłówków o frazy, które wpisują klienci w Google, to kluczowy element optymalizacji SEO."},{id:"q4",type:"multi-task",question:`Masz stronę z opisem oferty:

„Zapraszamy do naszego obiektu. Mamy pokoje i śniadania. Blisko centrum. Skontaktuj się z nami."

Twoim zadaniem jest zoptymalizować ten tekst pod SEO. Wykonaj poniższe 3 zadania:`,subTasks:[{id:"q4-1",title:"Zadanie 1: Główna fraza kluczowa",description:'Wymyśl główną frazę, na którą chcesz się wyświetlać w Google.\nPrzykład: „nocleg blisko centrum miasta X ze śniadaniem"',keywords:["nocleg","hotel","pokoje","centrum","miasto","śniadanie","fraza","kluczowa"],hint:"Pomyśl o konkretnej frazie, którą wpisują klienci szukając Twojej oferty..."},{id:"q4-2",title:"Zadanie 2: Tytuł (H1)",description:"Napisz na nowo tytuł (H1) tej podstrony, używając wybranej frazy kluczowej.",keywords:["tytuł","h1","nagłówek","fraza","kluczowa"],hint:"Tytuł powinien zawierać główną frazę kluczową i być konkretny..."},{id:"q4-3",title:"Zadanie 3: Opis (4–6 zdań)",description:`Napisz 4–6 zdań opisu, w kt\xf3rym:
• naturalnie użyjesz wybranej frazy kluczowej,
• dodasz 2–3 konkretne informacje (np. godziny śniadań, parking, Wi-Fi),
• zakończysz wezwaniem do działania (np. „Sprawdź dostępne terminy").`,keywords:["opis","treść","fraza","kluczowa","informacje","parking","wi-fi","śniadanie","wezwanie","działanie","zarezerwuj","sprawdź","terminy"],hint:"Pomyśl o konkretnych informacjach, które są ważne dla klientów i naturalnie wpleć frazę kluczową..."}],feedback:"Dziękuję za odpowiedź. To ćwiczenie pomoże Ci lepiej zrozumieć, jak optymalizować treści pod SEO, używając konkretnych fraz kluczowych i strukturyzując treść."}]}]},{id:"3",title:"Reklamy płatne w mediach społecznościowych",icon:"megaphone",lessons:[{id:"3.1",moduleId:"3",title:"Tworzenie skutecznych kampanii na Facebooku i Instagramie",intro:`Reklamy płatne w mediach społecznościowych (Facebook / Instagram Ads) pozwalają dotrzeć z ofertą dokładnie do os\xf3b, kt\xf3re są dla Ciebie najważniejsze – według lokalizacji, wieku, zainteresowań czy zachowań.

Dla obiektu noclegowego oznacza to możliwość pokazania oferty osobom, kt\xf3re:

• mieszkają w określonym promieniu od Twojej lokalizacji lub w konkretnych miastach,

• interesują się podr\xf3żami, noclegami, wyjazdami służbowymi, wydarzeniami w regionie,

• szukają miejsca na wyjazd weekendowy, szkolenie, konferencję lub nocleg pracowniczy.`,whyImportant:[{title:"Szybka budowa rozpoznawalności",description:"Pomagają szybko zbudować rozpoznawalność obiektu na rynku",points:[],icon:"visibility"},{title:"Wypełnianie konkretnych terminów",description:"Pozwalają wypełniać konkretne terminy (np. dni robocze poza sezonem)",points:[],icon:"target"},{title:"Testowanie różnych ofert",description:"Umożliwiają testowanie różnych ofert (weekendy dla par, noclegi dla firm, pakiety rodzinne)",points:[],icon:"analytics"},{title:"Dotarcie do nowych klientów",description:"Pozwalają dotrzeć do osób spoza Twojej miejscowości, które inaczej by o Tobie nie usłyszały",points:[],icon:"traffic"},{title:"Kontrola nad kosztami",description:"Dają dużą kontrolę nad kosztami – możesz zacząć od małego budżetu dziennego i zwiększać go dopiero wtedy, gdy kampania przynosi efekt",points:[],icon:"cost-seo"}],whyImportantFooter:`Bez płatnych kampanii jesteś w dużej mierze zależny od:
...
Z kampaniami płatnymi możesz świadomie „włączać" i „wzmacniać" widoczność wybranych ofert wtedy, kiedy najbardziej ich potrzebujesz.`,practicalExamples:[{title:'Przykład praktyczny 1 – „Weekend dla par"',description:`Obiekt noclegowy położony w pobliżu atrakcji turystycznych ma wolne miejsca w weekendy poza gł\xf3wnym sezonem.
...
• opis: „Weekendowy pobyt dla dwojga: 2 noce ze śniadaniami, parking w cenie, p\xf3źne wymeldowanie",

• grafika: realne zdjęcie pokoju oraz sali śniadaniowej,

• wezwanie do działania: „Sprawdź dostępne terminy".`,effect:"Reklama trafia do osób, które realnie mogą przyjechać na krótki wyjazd i szukają odpoczynku w rozsądnej odległości od domu."},{title:'Przykład praktyczny 2 – „Noclegi dla firm i pracowników"',description:`Obiekt położony blisko strefy przemysłowej chce dotrzeć do firm delegujących pracownik\xf3w.
...
• opis: „Noclegi dla pracownik\xf3w z fakturą VAT, parkingiem i śniadaniem. Elastyczne warunki dla firm",

• grafika: zdjęcie parkingu, pokoju i sali śniadaniowej,

• wezwanie do działania: „Napisz, przygotuję ofertę dla Twojej firmy".`,effect:"Zamiast czekać, aż firma przypadkiem trafi na stronę, obiekt aktywnie wychodzi z ofertą do osób decyzyjnych."}],keyElements:[{title:"Jasno określony cel kampanii",description:"Co chcesz osiągnąć w tej konkretnej kampanii",points:["więcej wejść na stronę oferty","więcej zapytań o dostępność","więcej telefonów / wiadomości","większą rozpoznawalność obiektu w danym mieście / regionie"],icon:"target"},{title:"Precyzyjna grupa docelowa",description:"Kto ma zobaczyć tę reklamę",points:["pary szukające weekendu","rodziny z dziećmi","pracownicy w delegacji","organizatorzy szkoleń / wydarzeń"],icon:"audience"},{title:"Konkretna oferta i komunikat",description:"Co dokładnie proponujesz",points:['„Nocleg ze śniadaniem od 260 zł / doba"','„Pakiet weekendowy dla par"','„Noclegi pracownicze z fakturą VAT"',"Dlaczego ma to znaczenie dla klienta (korzyść, wygoda, oszczędność czasu / pieniędzy)"],icon:"benefits"},{title:"Dobra kreacja (grafika + tekst)",description:"Elementy skutecznej kreacji",points:["zdjęcie pokazujące rzeczywisty standard obiektu","krótki, czytelny tekst bez żargonu",'wyraźne wezwanie do działania („Sprawdź terminy", „Napisz wiadomość", „Zarezerwuj pobyt")'],icon:"content"},{title:"Budżet i czas trwania kampanii",description:"Planowanie budżetu",points:["start od niewielkiego budżetu dziennego (np. 20–40 zł)","minimum kilka–kilkanaście dni na przetestowanie skuteczności"],icon:"cost-seo"},{title:"Spójność reklamy i miejsca docelowego",description:"Zapewnienie spójności",points:['jeżeli reklamujesz „Weekend dla par" – użytkownik po kliknięciu powinien trafić dokładnie na stronę z opisem tego pakietu, a nie na ogólną stronę główną'],icon:"experience"}],checklist:[{id:"check-1",text:"Czy cel kampanii jest jasno określony i jeden na kampanię?"},{id:"check-2",text:"Czy wiesz dokładnie, do kogo kierujesz tę konkretną ofertę?"},{id:"check-3",text:"Czy treść reklamy jasno mówi: co, dla kogo, w jakiej cenie / na jakich warunkach?"},{id:"check-4",text:"Czy grafika jest wyraźna, aktualna i pokazuje Twój obiekt, a nie przypadkowe zdjęcie z banku zdjęć?"},{id:"check-5",text:"Czy miejsce, do którego kierujesz użytkownika po kliknięciu, jest spójne z reklamą i łatwe w obsłudze (strona / formularz / wiadomość)?"},{id:"check-6",text:"Czy masz zaplanowane minimum kilka dni na obserwację wyników i drobne korekty (zamiast zmieniać wszystko po 1–2 dniach)?"}],quiz:[{id:"q1",type:"choice",question:"Co jest fundamentem skutecznej kampanii reklamowej na Facebooku / Instagramie dla obiektu noclegowego?",options:["Jak najwyższy budżet reklamowy","Precyzyjnie określony cel i grupa docelowa","Jak największa liczba różnych grafik","Publikowanie reklam wyłącznie w weekendy"],correctAnswer:1,feedback:"Dokładnie tak – fundamentem skutecznej kampanii jest precyzyjnie określony cel i dobrze zdefiniowana grupa docelowa."},{id:"q2",type:"choice",question:"Który przykład najlepiej opisuje przemyślaną ofertę reklamową?",options:['„Zapraszamy do naszego hotelu, mamy wolne pokoje."','„Hotel w centrum miasta, pokoje 2-osobowe, szczegóły na stronie."','„Weekend dla par: 2 noce ze śniadaniami, darmowy parking i późne wymeldowanie. Sprawdź dostępne terminy."','„Kliknij, żeby zobaczyć nasz profil na Facebooku."'],correctAnswer:2,feedback:"Dokładnie tak – przemyślana oferta reklamowa zawiera konkretne informacje (co, dla kogo, na jakich warunkach) i jasne wezwanie do działania."},{id:"q3",type:"choice",question:"Dlaczego warto zaczynać kampanię od mniejszego budżetu dziennego (np. 20–40 zł)?",options:["Bo niższy budżet automatycznie poprawia jakość reklamy","Bo wtedy reklama nie wyświetli się zbyt często","Bo pozwala bez dużego ryzyka przetestować grupy odbiorców i kreacje przed zwiększeniem wydatków","Bo Facebook nie pozwala na wyższe budżety dla nowych kont"],correctAnswer:2,feedback:"Dokładnie tak – zaczynanie od mniejszego budżetu pozwala na bezpieczne testowanie różnych grup docelowych i kreacji przed zwiększeniem wydatków."}]},{id:"3.2",moduleId:"3",title:"Analiza wyników kampanii",intro:`Samo uruchomienie kampanii reklamowej na Facebooku czy Instagramie to dopiero początek. Prawdziwa praca zaczyna się wtedy, gdy zaczynamy regularnie sprawdzać wyniki i na tej podstawie podejmować decyzje:
...
Analiza wynik\xf3w kampanii pozwala zamienić „strzelanie na ślepo” w świadome, oparte na danych decyzje marketingowe.`,whyImportant:[{title:"Nie każda reklama działa tak samo",description:"Różne grupy odbiorców reagują na inne komunikaty i formy",points:["to, co działa zimą, nie musi działać latem","różne cele (weekendy, pracownicy, rodziny) mają różne wyniki"],icon:"target"},{title:"Bez analizy tracisz budżet",description:"Płacisz za kliknięcia, które nie prowadzą do rezerwacji",points:["ładne kreacje nie zawsze działają","brak danych = brak pewności, czy pieniądze pracują"],icon:"cost-seo"},{title:"Z analizą podejmujesz świadome decyzje",description:"Przesuwasz budżet do kampanii, które działają najlepiej",points:["wyłączasz słabe kampanie","poprawiasz wyniki krok po kroku zamiast zaczynać od zera"],icon:"analytics"}],keyElements:[{title:"CTR (Click-Through Rate)",description:"Pokazuje, jaki procent osób kliknął reklamę",points:["niski CTR = słaba grafika lub zbyt ogólny tekst","warto porównywać CTR między kampaniami"],icon:"visibility"},{title:"CPC (Cost Per Click)",description:"Średni koszt jednego kliknięcia",points:["pomaga porównywać kampanie","nie jest celem samym w sobie, ale sygnałem efektywności"],icon:"cost-seo"},{title:"Konwersje / zapytania / rezerwacje",description:"Najważniejszy wskaźnik realnych efektów",points:["połącz dane z reklam z formularzem / skrzynką / systemem rezerwacji","licz nie tylko kliknięcia, ale też ile osób napisało lub zadzwoniło"],icon:"cta"},{title:"Koszt pozyskania zapytania (CPA)",description:"Ile realnie kosztuje Cię jedno zapytanie lub rezerwacja",points:["ten wskaźnik mówi, czy kampania ma sens biznesowo","łatwiej porównywać różne kampanie i oferty"],icon:"benefits"},{title:"Zasięg i częstotliwość",description:"Jak szeroko i jak często widzą reklamę Twoi odbiorcy",points:["wysoka częstotliwość + brak efektów = reklama męczy odbiorców","czasem wystarczy odświeżyć kreację"],icon:"traffic"}],practicalExamples:[{title:"Przykład 1 – kampania „Weekend dla par”",description:`Prowadzisz dwie kampanie r\xf3wnolegle:

• Kampania A – reklama z jednym zdjęciem pokoju,

• Kampania B – reklama z kr\xf3tkim wideo pokazującym pok\xf3j, śniadanie i okolicę.

Po 10 dniach:

• Kampania A: CTR 1,2%, koszt kliknięcia 1,80 zł, 3 zapytania,

• Kampania B: CTR 2,9%, koszt kliknięcia 1,10 zł, 9 zapytań.`,effect:"Wideo działa lepiej – zwiększasz budżet Kampanii B i testujesz kolejne warianty wideo."},{title:"Przykład 2 – noclegi pracownicze",description:`Prowadzisz kampanię nocleg\xf3w dla firm i pracownik\xf3w:
...
2. Zobacz, z kt\xf3rych kampanii / zestaw\xf3w reklam realnie przychodzą zapytania / rezerwacje.
...
• Por\xf3wnywanie wynik\xf3w kampanii o r\xf3żnych celach.`,quiz:[{id:"q1",type:"choice",question:"Który wskaźnik najlepiej pokazuje, czy reklama jest atrakcyjna dla odbiorców?",options:["Liczba polubień strony","CTR (współczynnik kliknięć)","Łączny zasięg kampanii","Liczba wyświetleń reklamy"],correctAnswer:1,feedback:"CTR pokazuje, jaki procent odbiorców kliknął reklamę, więc najlepiej wskazuje atrakcyjność kreacji."},{id:"q2",type:"choice",question:"Co oznacza „koszt pozyskania zapytania / rezerwacji” (CPA)?",options:["Łączna kwota wydana na reklamy w danym miesiącu","Średni koszt jednego wyświetlenia reklamy","Średni koszt kampanii w ciągu jednego dnia","Ile średnio kosztuje jedno zapytanie lub rezerwacja wygenerowana przez kampanię"],correctAnswer:3,feedback:"CPA pokazuje, ile realnie płacisz za konkretne działanie klienta (zapytanie, rezerwację)."},{id:"q3",type:"choice",question:"Po 10 dniach kampanii widzisz, że reklama ma dużo kliknięć, ale mało zapytań. Co robisz?",options:["Zostawiam kampanię bez zmian","Zwiększam budżet, aby było więcej kliknięć","Sprawdzam treść reklamy i stronę docelową, zmieniam ofertę lub grupę docelową","Wyłączam wszystkie reklamy"],correctAnswer:2,feedback:"Należy sprawdzić spójność reklamy i strony docelowej oraz dopracować ofertę lub targetowanie."},{id:"q4",type:"open",question:"Jakie trzy konkretne wnioski chcesz wyciągać z wyników swoich kampanii i jak pomogą Ci podejmować decyzje?",keywords:["wnioski","działa","nie działa","budżet","target","oferta","decyzje"],hint:"Pomyśl o tym, co chcesz wiedzieć po analizie: które reklamy działają, jakie grupy warto rozwijać, czego unikać.",feedback:"Świadome wnioski z kampanii pomagają inwestować w to, co działa, i unikać marnowania budżetu."}]}]},{id:"4",title:"Budowanie relacji z klientami",icon:"users",lessons:[{id:"4.1",moduleId:"4",title:"Zarządzanie opiniami i recenzjami online",intro:`Opinie i recenzje online (Google, Booking, Facebook, portale rezerwacyjne) są dziś jednym z najważniejszych czynnik\xf3w wpływających na decyzje klient\xf3w. Zanim ktoś zadzwoni, napisze maila czy zarezerwuje nocleg, bardzo często najpierw sprawdza średnią ocen i kilka ostatnich komentarzy.`,whyImportant:[{title:"Zwiększenie liczby rezerwacji",description:"Wyższa średnia ocena = większe zaufanie",points:[],icon:"target"},{title:"Wyróżnienie się na tle konkurencji",description:"Nawet przy podobnym standardzie obiektu",points:[],icon:"visibility"},{title:"Szybsze wyłapywanie problemów",description:"Powtarzające się problemy (np. hałas, śniadania, sprzątanie) i realna poprawa jakości usług",points:[],icon:"analytics"},{title:"Budowanie wizerunku",description:"Firma jako miejsce, które słucha gości i reaguje na uwagi",points:[],icon:"trust"}],whyImportantFooter:`Brak reakcji na opinie lub emocjonalne odpowiedzi:

• obniża zaufanie nowych klient\xf3w,

• może sprawiać wrażenie chaosu organizacyjnego lub braku profesjonalizmu,

• wzmacnia negatywne wrażenie po pojedynczym, złym doświadczeniu.`,practicalExamples:[{title:"Przykład praktyczny 1 – obiekt noclegowy",description:`Gość wystawia opinię 3/5 na Google:

„Pok\xf3j czysty, ale w nocy było dość głośno od ulicy. Śniadanie ok, ale mogłoby być bardziej urozmaicone."
...
5. Monitoruj średnią ocenę oraz powtarzające się motywy i traktuj je jak darmowe badanie satysfakcji.`,roleDescriptionTitle:"Dobre praktyki zarządzania opiniami",quiz:[{id:"q1",type:"choice",question:"Jak powinna reagować profesjonalna firma na negatywną opinię online?",options:['Ignorować ją, żeby „nie robić szumu"',"Odpowiedzieć profesjonalnie, podziękować za opinię, przeprosić i zaproponować rozwiązanie","Usunąć opinię, jeśli to możliwe","Odpowiedzieć emocjonalnie, tłumacząc, że klient przesadza"],correctAnswer:1,feedback:"Dokładnie tak – profesjonalna odpowiedź na negatywną opinię pokazuje zaangażowanie w satysfakcję klienta i może przekształcić negatywną sytuację w pozytywną."},{id:"q2",type:"choice",question:"Które z poniższych działań najlepiej pomaga zwiększyć liczbę pozytywnych opinii?",options:["Czekanie, aż klienci sami z siebie napiszą recenzję","Prośba o opinię tylko wtedy, gdy ktoś narzeka","Systematyczne, uprzejme proszenie zadowolonych gości o pozostawienie opinii (np. przy wymeldowaniu, w mailu po pobycie)","Oferowanie rabatu w zamian za wyłącznie 5-gwiazdkowe opinie"],correctAnswer:2,feedback:"Dokładnie tak – systematyczne, uprzejme proszenie zadowolonych gości o opinie jest najlepszą praktyką, która naturalnie zwiększa liczbę pozytywnych recenzji."},{id:"q3",type:"choice",question:"Które stwierdzenie najlepiej opisuje rolę recenzji online w działalności hotelu lub pensjonatu?",options:["Mają znaczenie tylko dla turystów zagranicznych",'Są ważne głównie po to, żeby „ładnie wyglądały" w wyszukiwarce',"Silnie wpływają na decyzje rezerwacyjne i są jednym z kluczowych źródeł informacji dla nowych gości","Są mniej istotne niż ulotki i ogłoszenia drukowane"],correctAnswer:2,feedback:"Dokładnie tak – recenzje online silnie wpływają na decyzje rezerwacyjne i są jednym z pierwszych źródeł informacji, które sprawdzają potencjalni klienci przed rezerwacją."}]},{id:"4.2",moduleId:"4",title:"Komunikacja z klientami w mediach społecznościowych",intro:`Dla wielu os\xf3b Facebook czy Instagram to pierwszy punkt kontaktu z firmą. Zanim zadzwonią lub napiszą maila, szybciej wyślą wiadomość na Messengerze albo skomentują post. To oznacza, że spos\xf3b odpowiedzi w social mediach bardzo często decyduje o tym, czy klient zrobi kolejny krok (zapytanie o ofertę, rezerwacja, wizyta), czy po prostu przejdzie dalej.`,whyImportant:[{title:"Budowanie zaufania",description:'Firma jest „żywa", reaguje, odpowiada',points:[],icon:"trust"},{title:"Wzmacnianie wizerunku",description:"Profesjonalne, uporządkowane miejsce",points:[],icon:"visibility"},{title:"Zmniejszanie nieporozumień",description:"Np. źle zrozumiane godziny zameldowania, zasady rezerwacji",points:[],icon:"info"},{title:"Szybsze domykanie sprzedaży",description:"Zapytanie → konkretna propozycja → rezerwacja",points:[],icon:"sales"},{title:"Wpływ na postrzeganie",description:'Jak Twoją firmę postrzegają osoby, które tylko „podglądają" rozmowy pod postami, ale jeszcze się nie odezwały',points:[],icon:"relations"}],whyImportantFooter:`Brak odpowiedzi lub chaotyczne, emocjonalne reakcje:

• zniechęcają do zadawania pytań,

• obniżają poczucie bezpieczeństwa („czy ktoś w og\xf3le tam ogarnia?"),

• mogą zniechęcić do rezerwacji nawet przy dobrych zdjęciach i ofercie.`,practicalExamples:[{title:"Przykład praktyczny 1 – zapytanie na Messengerze",description:`Klient pisze wiadomość:
...
Cena: 260 zł / doba za pok\xf3j ze śniadaniem.

Możemy od razu zarezerwować miejsce – proszę o imię i nazwisko oraz przybliżoną godzinę przyjazdu. W razie pytań chętnie pomogę."`,effect:"Taka odpowiedź od razu zmniejsza liczbę kolejnych pytań, prowadzi klienta do konkretnej decyzji i pokazuje, że firma jest dostępna i zorganizowana."},{title:"Przykład praktyczny 2 – komentarz publiczny",description:`Pod postem pojawia się komentarz:
...
• pozwala budować relację „na spokojnie", poza chaosem medi\xf3w społecznościowych.`,whyImportant:[{title:"Docieranie do byłych klientów",description:"Możesz przypomnieć się przed kolejnym sezonem",points:[],icon:"remind"},{title:"Informowanie o nowościach",description:"Np. nowe pokoje, pakiety rodzinne, oferta świąteczna",points:[],icon:"info"},{title:"Kontrola nad komunikacją",description:"Nie jesteś zależny od algorytmów Facebooka czy Instagrama",points:[],icon:"organize"},{title:"Mierzenie efektów",description:"Widzisz, kto otworzył wiadomość, kto kliknął, co było interesujące",points:[],icon:"analytics"}],whyImportantFooter:`Bez email marketingu łatwo „zgubić" osoby, kt\xf3re były raz i… zniknęły. Z prostą listą mailingową możesz co jakiś czas przypomnieć im o sobie.`,practicalExamples:[{title:"Przykład praktyczny 1 – hotel / pensjonat",description:`Zał\xf3żmy, że prowadzisz pensjonat w mieście turystycznym. Po każdym pobycie prosisz gościa o zgodę na zapis do listy mailingowej (np. na recepcji lub w formularzu online).
...
• jasne CTA („kliknij" / „odpowiedz na maila").`,effect:"Personalizacja zwiększa zaangażowanie i szansę na konwersję, ponieważ wiadomość jest dopasowana do konkretnego odbiorcy i jego historii z firmą."}],automationScenariosIntro:"Nie trzeba od razu budować skomplikowanych lejków. W małej firmie już kilka prostych, dobrze ustawionych automatyzacji może zrobić dużą różnicę.",automationScenarios:[{id:"auto-1",title:"Seria powitalna dla nowych kontaktów",description:"Każda osoba, która zapisała się na newsletter lub zostawiła maila w formularzu.",icon:"mail",timeline:"Dzień 0, 3-5, 7-10",points:["Dzień 0 – mail powitalny: podziękowanie za zapis, krótka prezentacja obiektu/usługi",'Dzień 3–5 – mail z konkretną wartością: np. „Jak najlepiej zaplanować weekend w [regionie] – 3 sprawdzone pomysły"',"Dzień 7–10 – mail z pierwszą, delikatną propozycją: np. informacja o pakiecie z konkretnymi terminami"]},{id:"auto-2",title:"Mail przed przyjazdem / wizytą",description:"Wysyłany automatycznie np. 3–5 dni przed przyjazdem.",icon:"remind",timeline:"3-5 dni przed",points:["Przypomnienie terminu","Praktyczne informacje (parking, godziny zameldowania, dojazd)","Możliwość dopisania usług dodatkowych (np. śniadanie, późne wymeldowanie, dodatkowe łóżko)"]},{id:"auto-3",title:"Mail po pobycie / wykonaniu usługi",description:"Wysyłany 1–3 dni po zakończeniu pobytu/usługi.",icon:"relations",timeline:"1-3 dni po",points:["Podziękowanie","Prośba o opinię (np. link do Google / Booking)","Opcjonalnie: kod rabatowy na kolejny pobyt w mniej obłożonych terminach"]},{id:"auto-4",title:"Reaktywacja nieaktywnych klientów",description:"Do osób, które od dłuższego czasu nie otwierają maili / nie rezerwują.",icon:"traffic",timeline:"Po okresie nieaktywności",points:["Przypomnienie o marce","Zaproszenie z konkretną korzyścią (np. tańszy pobyt w tygodniu)",'Wyraźny CTA: „Jeśli nie chcesz otrzymywać takich wiadomości, możesz jednym kliknięciem się wypisać"']}],quiz:[{id:"q1",type:"choice",question:"Na czym polega automatyzacja w email marketingu?",options:["Na wysyłaniu jak największej liczby maili ręcznie","Na ustawieniu reguł, które wywołują wysyłkę odpowiednich wiadomości w określonym momencie (np. po zapisie, przed przyjazdem)","Na kupowaniu gotowych list mailingowych","Na wysyłaniu tej samej wiadomości do wszystkich kontaktów"],correctAnswer:1,feedback:"Dokładnie tak – automatyzacja polega na ustawieniu reguł, które automatycznie wywołują wysyłkę odpowiednich wiadomości w określonych momentach, bez konieczności ręcznego działania."},{id:"q2",type:"choice",question:"Który przykład najlepiej pokazuje sensowną personalizację maila?",options:['„Dzień dobry, zapraszamy wszystkich do skorzystania z naszej oferty."','„Witaj! Mamy promocję, szczegóły w załączniku."','„Dzień dobry Panie Marku, dziękujemy za Pana ostatni pobyt. Na najbliższe tygodnie przygotowaliśmy ofertę z rabatem dla stałych Gości. Jeśli chciałby Pan sprawdzić dostępność pokoi w listopadzie, proszę kliknąć w ten link."','„Szanowni Państwo, oferta ważna do odwołania."'],correctAnswer:2,feedback:"Dokładnie tak – najlepszy przykład zawiera personalizację (imię), nawiązanie do historii (ostatni pobyt), dopasowaną ofertę (rabat dla stałych Gości) i jasne wezwanie do działania (link)."},{id:"q3",type:"choice",question:"Jaka jest jedna z głównych korzyści automatyzacji kampanii emailowych w małej firmie?",options:["Możliwość wysyłania maili bez zgody odbiorców","Brak potrzeby planowania treści","Oszczędność czasu przy zachowaniu regularnego kontaktu z klientami","Zastąpienie wszystkich innych kanałów marketingowych"],correctAnswer:2,feedback:"Dokładnie tak – automatyzacja pozwala oszczędzić czas przy jednoczesnym zachowaniu regularnego, zaplanowanego kontaktu z klientami, co jest szczególnie wartościowe dla małych firm z ograniczonymi zasobami."},{id:"q4",type:"open",question:'Podaj jeden przykład wiadomości, którą w Twojej firmie można byłoby zautomatyzować (np. „mail przed przyjazdem z informacjami praktycznymi").',keywords:["automatyzacja","mail","wiadomość","przed","po","powitalny","przypomnienie","podziękowanie","reaktywacja","przyjazd","wizyta","pobyt","usługa","rezerwacja","termin","informacje","praktyczne","parking","dojazd","zameldowanie","opinia","rabat","kod"],hint:"Pomyśl o sytuacjach w Twojej firmie, które powtarzają się regularnie i wymagają wysłania podobnej wiadomości – np. przed przyjazdem, po pobycie, przy zapisie na newsletter...",feedback:"Dziękuję za odpowiedź. Automatyzacja powtarzalnych wiadomości to świetny sposób na oszczędność czasu przy jednoczesnym utrzymaniu profesjonalnej komunikacji z klientami."}]}]},{id:"6",title:"Analiza i optymalizacja",icon:"analytics",lessons:[{id:"6.1",moduleId:"6",title:"Narzędzia analityczne i ich zastosowanie",intro:`Narzędzia analityczne (takie jak Google Analytics, statystyki Meta, systemy raportowe z silnika rezerwacyjnego, narzędzia do email marketingu) pokazują, co naprawdę dzieje się z Twoim marketingiem:

kto wchodzi na stronę, skąd, co ogląda, w co klika, kiedy znika, a kiedy rezerwuje / dzwoni / pisze.

Bez tych danych decyzje podejmuje się „na wyczucie". Z danymi – możesz świadomie wzmacniać to, co działa, i odcinać to, co tylko generuje koszty.`,whyImportant:[{title:"Widzenie źródeł zapytań i rezerwacji",description:"Z jakich źródeł faktycznie przychodzą zapytania i rezerwacje (Google, social media, polecenia, reklamy)",points:[],icon:"analytics"},{title:"Ocena kampanii",description:'Które kampanie mają sens, a które tylko „zjadają budżet"',points:[],icon:"target"},{title:"Analiza zachowań klientów",description:"Jak zachowują się klienci na stronie – które podstrony działają, a które trzeba poprawić",points:[],icon:"data"},{title:"Lepsze planowanie budżetów",description:"Planowanie budżetów i sezonowość (np. jakie działania wzmacniać przed wysokim sezonem, a jakie wypełniają dołki obłożenia)",points:[],icon:"organize"},{title:"Szybsze wychwytywanie problemów",description:"Np. nagły spadek ruchu, niedziałający formularz, kampanię z bardzo wysokim kosztem kliknięcia",points:[],icon:"info"}],practicalExamples:[{title:"Przykład 1 – Ruch na stronie www i strona ofertowa",description:`Mały hotel w mieście turystycznym sprawdza w Google Analytics:

• ile os\xf3b miesięcznie odwiedza stronę,

• kt\xf3re podstrony są najczęściej oglądane (np. „Pokoje", „Cennik", „Kontakt"),

• jaki jest wsp\xf3łczynnik wyjść ze strony ofertowej (czy ludzie po wejściu od razu zamykają kartę, czy idą dalej).`,effect:'Jeśli wiele osób wchodzi na stronę „Oferta / Pokoje", a mało przechodzi do „Rezerwacja / Kontakt", to sygnał, że treść oferty, zdjęcia lub przyciski „zadzwoń / zarezerwuj" wymagają poprawy.'},{title:"Przykład 2 – Skuteczność reklam w social media",description:`Pensjonat uruchamia kampanię Meta Ads promującą pakiet weekendowy. Po tygodniu sprawdza w panelu reklamy:
...
• ile realnych zapytań / rezerwacji przyszło w tym okresie.`,effect:"Jeśli CTR jest wysoki, ale mało osób pyta o ofertę, to problem może być w stronie docelowej (treść, zdjęcia, brak jasnego telefonu / formularza)."},{title:"Przykład 3 – Email marketing i powroty Gości",description:`Obiekt noclegowy wysyła kampanię emailową do swoich byłych gości z propozycją pobytu poza wysokim sezonem. Narzędzie do emaili pokazuje:

• ile os\xf3b otworzyło wiadomość (open rate),

• ile kliknęło w link („zobacz terminy", „napisz do nas"),

• ile finalnie zarezerwowało pobyt.`,effect:"Na tej podstawie można ocenić, czy temat wiadomości zachęca do otwarcia, czy oferta jest wystarczająco konkretna i czy warto powtórzyć podobną akcję w przyszłości."}],quiz:[{id:"q1",type:"choice",question:"Które narzędzie jest najczęściej używane do analizy ruchu na stronie internetowej?",options:["Program do faktur","Google Analytics","Edytor zdjęć","Messenger"],correctAnswer:1,feedback:"Dokładnie tak – Google Analytics to najpopularniejsze i najczęściej używane narzędzie do analizy ruchu na stronie internetowej."},{id:"q2",type:"choice",question:"Co mierzy współczynnik konwersji strony docelowej (np. strony z ofertą)?",options:["Średni czas ładowania strony","Odsetek osób, które weszły na stronę i od razu ją zamknęły",'Odsetek odwiedzających, którzy wykonali pożądane działanie (np. wysłali formularz, kliknęli „Zadzwoń", dokonali rezerwacji)',"Liczbę polubień profilu w social media"],correctAnswer:2,feedback:'Dokładnie tak – współczynnik konwersji mierzy odsetek odwiedzających, którzy wykonali pożądane działanie, takie jak wysłanie formularza, kliknięcie w przycisk „Zadzwoń" lub dokonanie rezerwacji.'},{id:"q3",type:"choice",question:"Co powinno być pierwszym krokiem przed analizą danych z narzędzi analitycznych?",options:["Zwiększenie budżetu reklamowego","Zmiana wszystkich tekstów na stronie","Jasne określenie celu (np. więcej rezerwacji bezpośrednich, więcej zapytań z formularza)","Instalacja jednocześnie kilku różnych systemów analitycznych"],correctAnswer:2,feedback:"Dokładnie tak – przed analizą danych należy jasno określić cel, co pozwala na właściwą interpretację wskaźników i podejmowanie trafnych decyzji."},{id:"q4",type:"choice",question:"Który z poniższych wskaźników jest najmniej przydatny sam w sobie, jeśli nie jest powiązany z celem biznesowym?",options:["Liczba rezerwacji z formularza na stronie","Liczba polubień postu na Facebooku",'Współczynnik konwersji strony „Oferta"',"Liczba wysłanych zapytań w miesiącu"],correctAnswer:1,feedback:"Dokładnie tak – liczba polubień postu na Facebooku sama w sobie nie przekłada się bezpośrednio na cele biznesowe, takie jak rezerwacje czy zapytania, jeśli nie jest powiązana z konkretnymi działaniami."},{id:"q5",type:"choice",question:"Co w praktyce oznacza wysoki CTR reklamy (dużo kliknięć) i jednocześnie wysoki koszt pozyskania rezerwacji?",options:["Reklama słabo przyciąga uwagę, ale strona świetnie zamienia odwiedzających w klientów","Reklama przyciąga uwagę, ale oferta / strona docelowa nie przekonuje do rezerwacji","Wszystko działa idealnie i nie trzeba nic zmieniać","Należy natychmiast wyłączyć wszystkie kampanie"],correctAnswer:1,feedback:"Dokładnie tak – wysoki CTR oznacza, że reklama przyciąga uwagę, ale wysoki koszt pozyskania rezerwacji sugeruje, że oferta lub strona docelowa nie przekonuje odwiedzających do rezerwacji."},{id:"q6",type:"choice",question:"Jak często mała firma powinna minimum przeglądać podstawowe raporty z działań marketingowych (ruch na stronie, kampanie, maile), aby sensownie reagować?",options:["Raz na rok","Raz na pół roku","Przynajmniej raz w tygodniu (lub częściej w okresach intensywnych kampanii)","W ogóle nie trzeba, jeśli są włączone reklamy"],correctAnswer:2,feedback:"Dokładnie tak – regularne przeglądanie raportów (przynajmniej raz w tygodniu, a częściej w okresach intensywnych kampanii) pozwala na szybkie reagowanie i optymalizację działań marketingowych."}]},{id:"6.2",moduleId:"6",title:"Optymalizacja działań marketingowych i podejmowanie decyzji na podstawie danych",intro:`Optymalizacja działań marketingowych to nie jednorazowe „ustawienie kampanii", ale ciągły proces:
