...
– „tylko przy zamówieniu przez wiadomość prywatną".`,
        quiz: [
          ...
          },
          {
            ...
            keywords: ['catering', 'menu', 'zestawy', 'rodzina', 'firma', 'przyjęcie', 'zadzwoń', 'napisz', 'zamów', 'sprawdź', 'terminy'],
...
– „Zadzwoń, jeśli potrzebujesz cateringu na spotkanie firmowe."`,
        quiz: [
          ...
          },
          {
            ...
            keywords: ['historia', 'klienci', 'sytuacja', 'docenili', 'wezwanie', 'działanie', 'zamów', 'napisz', 'sprawdź', 'terminy'],
            ...
            subTasks: [
              {
                ...
                keywords: ['catering', 'menu', 'zestawy', 'dostawa', 'miasto', 'przyjęcie', 'fraza', 'kluczowa'],
...
• zakończysz wezwaniem do działania (np. „Sprawdź termin realizacji").`,
                keywords: ['opis', 'treść', 'fraza', 'kluczowa', 'informacje', 'dostawa', 'menu', 'zestawy', 'wezwanie', 'działanie', 'zamów', 'sprawdź', 'terminy'],
...
• jasne CTA („kliknij" / „odpowiedz na maila").`,
        ...
        quiz: [
          ...
          },
          {
            ...
            keywords: ['automatyzacja', 'mail', 'wiadomość', 'przed', 'po', 'powitalny', 'przypomnienie', 'podziękowanie', 'reaktywacja', 'realizacja', 'wizyta', 'usługa', 'zamówienie', 'termin', 'informacje', 'praktyczne', 'dostawa', 'odbiór', 'opinia', 'rabat', 'kod'],
            ...
            subTasks: [
              {
                ...
                fieldOptions: {
                  multipleFields: [
                    ...
                    { label: 'Liczba zapytań/zamówień (Leads)', placeholder: 'np. 10' }
                  ]
                }
              },
              {
