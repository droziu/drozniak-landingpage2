...
export const ContactAside: React.FC = () => {
  return (
    <div className="lg:sticky lg:top-24 space-y-6">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <a 
              ...
              className="text-[#fee715] hover:text-white transition-colors duration-300"
            >
      ...
      {/* Rozmowa Card */}
      <div className="bg-white/5 border border-white/10 rounded-xl p-6">
        <h3 className="font-medium text-white mb-3">Wolisz od razu porozmawiać?</h3>
        <a
          href="https://calendly.com/drozniakstanislaw/spotkanie"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block border border-[#fee715] text-[#fee715] hover:bg-[#fee715] hover:text-[#101820] font-medium py-2 px-4 rounded-lg transition-all duration-300 text-sm"
        >
