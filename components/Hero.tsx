...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center text-center py-2 md:py-20 px-4 md:px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <div ref={fadeInYellow.ref} className={`mb-4 md:mb-6 ${fadeInYellow.className}`}>
          <span className="bg-gradient-to-r from-[#fee715] to-[#00C9A7] hover:from-[#00C9A7] hover:to-[#fee715] bg-clip-text text-transparent font-[Montserrat] text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight md:leading-relaxed transition-all duration-500 cursor-pointer">Brakuje Ci systemu.</span>
        </div>
