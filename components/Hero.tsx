  ...
  return (
    <section className="min-h-screen flex flex-col justify-center text-center py-12 md:py-20 px-4 md:px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="mb-8">
          <span className="bg-gradient-to-r from-[#fee715] to-[#00C9A7] bg-clip-text text-transparent font-[Montserrat] text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold leading-relaxed">Brakuje Ci systemu.</span>
        </div>
