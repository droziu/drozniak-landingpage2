...
// For now, we'll use a wrapper approach or move metadata to parent
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {trainingTypes.map((training, index) => (
              ...
              >
                ...
                <p className="text-gray-300 text-sm leading-relaxed flex-grow" dangerouslySetInnerHTML={{ __html: training.description }} />
              </div>
            ))}
          </div>
        </section>
