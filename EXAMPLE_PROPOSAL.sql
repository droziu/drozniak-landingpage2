-- Przykładowa oferta - Uporządkowanie i prowadzenie marketingu Grupy Fibra
-- Uruchom ten skrypt w Supabase SQL Editor po utworzeniu pierwszej oferty przez UI
-- UWAGA: Musisz najpierw mieć aktywnego użytkownika (admin) i klienta marketingowego

-- 1. Wstaw ofertę (zastąp USER_ID i CLIENT_ID swoimi wartościami)
-- Możesz również utworzyć ofertę przez UI (/admin/proposals/new), a potem zaktualizować treść

-- Przykład aktualizacji istniejącej oferty (jeśli masz już ID oferty):
/*
...
WHERE proposal_id = 'TWOJE_PROPOSAL_ID'
AND version_number = 1;
*/

-- INSTRUKCJA:
-- 1. Otwórz /admin/proposals/new w aplikacji
-- 2. Wypełnij podstawowe dane (tytuł: "Oferta współpracy – uporządkowanie i prowadzenie marketingu Grupy Fibra")
-- 3. Kliknij "Utwórz ofertę"
-- 4. Skopiuj ID oferty z URL (np. /admin/proposals/123e4567-e89b-12d3-a456-426614174000)
-- 5. Uruchom powyższy UPDATE z właściwym ID oferty
-- 6. Kliknij "Zapisz zmiany" w edytorze, aby zobaczyć zmiany
-- 7. Użyj przycisku "Generuj link", aby utworzyć publiczny link do oferty
